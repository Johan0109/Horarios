...
$date_i_VII=$_POST['date_i_VII'];   $date_f_VII=$_POST['date_f_VII']; $instructor_7=$_POST['instructor_7'];
...
$trim_VII="VII Trimestre";
 ...
 $query = "INSERT INTO `tb_trimestre` (`id_T`,`Trim_date_Inc`,`Trim_date_fin`,`Trimestre`,`id_fch`, `instructor_id`) VALUES 
     ...
     (NULL,'$date_i_VII','$date_f_VII','$trim_VII','$ficha_fechas','$instructor_7')";
